...
//         // FIXME !pr this try catch do NOT catch error when jsonData[ms_VERSION] doesn't exist
//         try {
//             isVersionIncorrect = CONFIG_VERSION != jsonData[ms_VERSION].get<uint8_t>();
//         } catch (...) {
//             mpLogger->error("OtaESP32", "aaa");
//         }
