...
// //
// //                     mpCommunication->sendMessage(messageBuffer); // send response to connection request
// //                     mAckNumber = calculateNewAckNumber(message, mAckNumber);
// //                     // TODO remove
...
// //
// //             xSemaphoreGive(mConnectionDataMutex);
// //             mpCommunication->sendMessage(messageBuffer);
// //         }
// //         return false;
// //     }
// //
...
// //                     con.mpCommunication->sendMessage(messageBuffer);
// //                     continue;
// //                 }
// //
...
// //                 }
// //
// //                 // wait for semaphore (received RF message), calc and add ack num and call con.mpCommunication->sendMessage(messageBuffer);
