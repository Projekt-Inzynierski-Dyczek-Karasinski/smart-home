...
#define ENTER_SLEEP_TASK_SIZE               BIG_TASK_SIZE
...
#define WINDOW_SENSOR_FIRST_SLEEP_TASK_SIZE BIG_TASK_SIZE
#define WINDOW_SENSOR_NOTIFY_TASK_SIZE      MEDIUM_TASK_SIZE
