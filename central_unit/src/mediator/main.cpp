...
int main(int argc, char *argv[]) {
    ...
    auto loggerConfig = SmartHome::Utils::Logger::Config();
    loggerConfig.logLevel = SmartHome::Utils::LogLevels::Level::DEBUG;
    loggerConfig.enableConsoleLogOutput = true;
    loggerConfig.logFile.path = "/var/log/mediator.log";
    loggerConfig.logFile.enabled = true;
    logger->applyConfig(loggerConfig);

    auto &mediator = SmartHomeMediator::Mediator::Instance();
    auto config = SmartHomeMediator::Mediator::Config();
